...
##' @return NULL
##' @author Romain Lorrilliere
exploreData <- function(file="stoc_20161011.txt",fileDataClean="data.csv",fileData3sessions = "data3session.csv") {
    fileBrut="stoc_20161011.txt";fileDataClean="data.csv";fileData3sessions = "data3session.csv"
...
##  file="stoc_20180616.txt";fileDataClean="data.csv";fileData3sessions = "data3session.csv"#####
##   lastYear=2017;importationData="brut";all=TRUE;local=TRUE;site=NULL #####
##    seuilAbondanceAnneeAll=30;seuilAbondanceAnneeSite=10 #####
